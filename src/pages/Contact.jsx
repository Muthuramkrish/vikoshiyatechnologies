          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 flex flex-col justify-center text-lg md:text-xl gap-5">
              ...
              <div className="flex gap-5 mt-4">
                ...
                <a href="https://whatsapp.com/channel/0029Vb6Oqf3ISTkIJqCVf03t" target="_blank" className="text-blue-600 hover:text-blue-800 text-2xl transition-colors" aria-label="Whatsapp">
